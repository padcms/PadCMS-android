 ...
 */
public class HelpElementView extends BaseElementView {

	private ImageView scrpllingPanelView;

	public HelpElementView(Context mContext, String pathToPortain) {
		super(null, null);
		resourcePathStr = pathToPortain;

		resourceController = new ImageViewController(mContext, resourcePathStr,
				ApplicationManager.elementResolution);
...
//	public HelpElementView(BasePageView parentPageView, Element element) {
...
//	}
	...
	public ResourceResolutionHelper getResolutionForController(Bitmap bitmap) {
		...
		return ResourceResolutionHelper.getBitmapResolution(
